...
export const jobSearchOsProject = {
  name: "Job Search OS",
  description:
    "Local-first AI-powered job search operating system coordinating specialized agents, RAG over approved career evidence, MCP tooling, LangGraph-assisted application automation, job scoring, search strategy, resume and cover letter generation, application packet QA, recruiter outreach, outcome learning, and controlled browser workflows.",
  ...
  highlights: [
    ...
    "Added LangGraph-backed application assistant workflow state for package validation, browser launch, field inspection, field commands, Needs Me pauses, resume with user answers, and ready-to-submit tracking.",
    "Built a local Playwright browser assistant that performs safe autofill, file uploads, field inventory reporting, workflow command execution, manual input observation, and submit-confirmation detection while preserving manual final submit.",
    "Added live Needs Me alert streaming with server-sent events so blocker state updates automatically while agents are running.",
